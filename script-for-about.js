...
cursed.onclick = function() {
    ...
    bg.style.backgroundImage = "linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('images/62ac9cbbc576f070768c1d4665fe42ad.jpg')";
    bg.style.backgroundRepeat = "repeat";
    bg.style.backgroundSize = "contain";
    var main_block_bg = document.querySelector('.main-content');
    main_block_bg.style.backgroundImage = "url('images/62ac9cbbc576f070768c1d4665fe42ad.jpg')";   
    var logo_bg = document.getElementById('logo');
    logo_bg.style.backgroundImage = "url('images/62ac9cbbc576f070768c1d4665fe42ad.jpg')";
    var navLinks_bg = document.querySelector('.nav-links');
    navLinks_bg.style.backgroundImage = "url('images/62ac9cbbc576f070768c1d4665fe42ad.jpg')";
    var strange_images = document.querySelector('.strange-img.one');
    strange_images.src = "images/62ac9cbbc576f070768c1d4665fe42ad.jpg";
    var strange_images2 = document.querySelector('.strange-img.two')
    strange_images2.src = "images/62ac9cbbc576f070768c1d4665fe42ad.jpg";
    var strange_images3 = document.querySelector('.strange-img.three')
    strange_images3.src = "images/62ac9cbbc576f070768c1d4665fe42ad.jpg";
    var pfp = document.querySelector('.pfp');
    pfp.src = "images/62ac9cbbc576f070768c1d4665fe42ad.jpg";
